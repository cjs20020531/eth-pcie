...
wire        sfp_drp_clk = clk_50mhz_int;
wire        sfp_drp_rst = rst_50mhz_int;
...
gig_ethernet_pcs_pma_0 gig_ethernet_pcs_pma_0 (
  ...
  .txn(sfp0_tx_n),                                        // output wire txn
  .txp(sfp0_tx_p),                                        // output wire txp
  .rxn(sfp0_rx_n),                                        // input wire rxn
  .rxp(sfp0_rx_p),                                        // input wire rxp
  .independent_clock_bufg(sfp_drp_clk),  // input wire independent_clock_bufg
  .userclk_out(),                        // output wire userclk_out
  .userclk2_out(phy_rx_clk),                      // output wire userclk2_out
  .rxuserclk_out(),                    // output wire rxuserclk_out
  .rxuserclk2_out(),                  // output wire rxuserclk2_out
  .gtpowergood(sfp_gtpowergood),                        // output wire gtpowergood
  .resetdone(pcs_resetdone),                            // output wire resetdone
  .pma_reset_out(),                    // output wire pma_reset_out
  .mmcm_locked_out(pcs_mmcm_locked),                // output wire mmcm_locked_out
  .gmii_txd(phy_txd),                              // input wire [7 : 0] gmii_txd
  .gmii_tx_en(phy_tx_en),                          // input wire gmii_tx_en
  .gmii_tx_er(phy_tx_er),                          // input wire gmii_tx_er
  .gmii_rxd(phy_rxd),                              // output wire [7 : 0] gmii_rxd
...
assign ptp_clk = clk_125mhz_int;
assign ptp_rst = rst_125mhz_int;
