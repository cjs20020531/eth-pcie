...
design_libs=(xpm gtwizard_ultrascale_v1_7_17 xil_defaultlib gig_ethernet_pcs_pma_v16_2_15)
...
compile()
{
  ...
  vlogan -work gtwizard_ultrascale_v1_7_17 $vlogan_opts +v2k \
  ...
  vhdlan -work gig_ethernet_pcs_pma_v16_2_15 $vhdlan_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vlogan -work gig_ethernet_pcs_pma_v16_2_15 $vlogan_opts +v2k \
...
reset_run()
{
  files_to_remove=(ucli.key gig_ethernet_pcs_pma_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gig_ethernet_pcs_pma_0_simv.daidir vcs_lib c.obj)
