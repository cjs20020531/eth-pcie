...
#
# Script generated by Vivado on Mon Sep 07 15:57:53 +0800 2026
...
design_libs_elab="-libname xpm -libname gtwizard_ultrascale_v1_7_17 -libname xil_defaultlib -libname gig_ethernet_pcs_pma_v16_2_15 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm gtwizard_ultrascale_v1_7_17 xil_defaultlib gig_ethernet_pcs_pma_v16_2_15)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "gig_ethernet_pcs_pma_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_17 $xmvlog_opts \
  ...
  xmvhdl -work gig_ethernet_pcs_pma_v16_2_15 $xmvhdl_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work gig_ethernet_pcs_pma_v16_2_15 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.gig_ethernet_pcs_pma_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.gig_ethernet_pcs_pma_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log gig_ethernet_pcs_pma_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
